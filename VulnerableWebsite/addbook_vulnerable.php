...
// ❌ No role check — vulnerable: any logged-in user can access this page
...
?>
<!DOCTYPE html>
<html><head><title>Add Book (Vulnerable)</title><style>
...
<div class="container">
    ...
    <!-- ❌ No role check: even non-admins can use this form -->
